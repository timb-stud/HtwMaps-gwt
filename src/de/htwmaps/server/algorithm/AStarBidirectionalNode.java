 ...
 */
public class AStarBidirectionalNode extends Node {
	 ...
	 */
	public void setPredecessor(AStarBidirectionalNode predecessor) {
	 ...
	 */
	public AStarBidirectionalNode getPredecessor() {
		return predecessor;
	}
