...
public class RouteToText {
	 ...
	 *            Array mit Kanten welche besucht werden
	 * @throws SQLException
	 *             Moegliche Fehler beim beschaffen der Daten (Straßennamen
	 *             etc.)
	 * @throws MySQLException 
	 */
	private void createInfo(Node[] route, AStarEdge[] edge) throws SQLException, MySQLException {
		...
		for (int i = route.length - 1; i > 0; i--) {
			...
			// Bestimmt ob Stra�ennamen oder Straßenbezeichnung (L123)
			...
			// prueft ob aktuelle Strasse noch selbe Straße ist wie Durchlauf
			// vorher
...
//		return (df.format(hours) + ":" + df.format(minutes) + ":" + df.format(seconds));
	...
	public String toString() {
		...
		sb.append("Distance: " + "\t Straße: " + "\t\t Additional: "
		...
		sb.append("\nAnzahl Straßen: " + i + " Gesamt Entfernung: "
